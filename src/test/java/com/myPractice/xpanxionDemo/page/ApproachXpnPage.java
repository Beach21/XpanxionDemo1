...
public class ApproachXpnPage {
	...
	/** Constructor */
	public ApproachXpnPage(WebDriver driver) {
	...
	public ContactXpnPage resetPasswordStep1() {
		...
		return PageFactory.initElements(driver, ContactXpnPage.class);
