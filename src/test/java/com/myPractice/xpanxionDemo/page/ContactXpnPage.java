...
public class ContactXpnPage {
	...
	/** Constructor */
	public ContactXpnPage(WebDriver driver) {
	...
	public CareersXpnPage resetPasswordStep2() {

		fillNewPassword();
		fillConfirmPassword();
		clickBtnChangePassword();		

		return PageFactory.initElements(driver, CareersXpnPage.class);
